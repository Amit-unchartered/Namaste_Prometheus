...
class HandleRequests(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        #REQUEST_INPROGRESS.inc() #request is in process
        time.sleep(5) #to be able to see the process
        ...
        #REQUEST_LAST_SERVED.set(time.time()) #it will store the current time stamp in the app_last_served
        #REQUEST_INPROGRESS.dec() #request is completed
